...
## Vista previa de la app Diálogo alerta - Elaborar una aplicación de Diálogo alerta.
...
### Después hacemos click el MyApp pulsamos la tecla F2 y cambiamos el nombre por AlertDialog.
